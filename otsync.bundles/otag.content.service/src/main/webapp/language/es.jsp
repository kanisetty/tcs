...
<%
	 platform_not_supported = "Su plataforma no es compatible.";
	...
	// Android
	 ...
	 android_os_detected_pre = "Android SO";
	...
	//iOS
	 ...
	 ios_install_build = "Instale la última versión";
	...
	//Download Text
	 ...
	 win_download_text_32_bit = "BAJAR 32 BITS";
	 win_download_text_64_bit = "BAJAR 64 BITS";
	 win_alttext_32_bit = "cliente de 32 bits";
	 win_alttext_64_bit = "cliente de 64 bits";
		
	//WINDOWS
	 win_version = "VERSIÓN";
	 win_reliable_etc = "Compartir y sincronizar archivos de forma segura en el entorno probado y fiable de {0}.";
	 win_or_download = "O, baje el ";

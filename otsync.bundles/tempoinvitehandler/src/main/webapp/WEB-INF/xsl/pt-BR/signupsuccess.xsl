							...
							<div class="yui-g">
								<div class="formdlg">
									...
									<div class="formdlgmiddle">
										<div class="formdlgmessage">Obrigado! Sua conta está configurada e pronta para ser usada por você. Um e-mail com as informações de sua conta e links úteis foi enviado para</div>

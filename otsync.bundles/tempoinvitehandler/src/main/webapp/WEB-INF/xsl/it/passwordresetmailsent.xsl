							...
							<div class="yui-g">
								<div class="formdlg">
									...
									<div class="formdlgmiddle">
										<div class="formdlgmessage">Grazie. È stata inviata un'e-mail a</div>
										...
										<div class="formdlgmessage">Fai clic sul collegamento presente nell'e-mail per reimpostare la password.</div>
									</div>
									<xsl:call-template name="form-line-spacer"></xsl:call-template>

angular.module('collaboratorsService', ['collaboratorFactory', 'urlEncodingService', 'emailService', 'Request'])

    .factory('$collaboratorsService', ['$q', '$sessionService', 'collaboratorFactory', '$urlEncode', '$displayMessageService', '$emailService', 'Request',
            function($q, $sessionService, collaboratorFactory, $urlEncode, $displayMessageService, $emailService, Request) {
                ...
                return {
                    ...
                    getCollaboratorsAvailableForSharing: function(sharedCollaborators, allCollaborators){

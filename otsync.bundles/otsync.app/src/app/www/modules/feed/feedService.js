angular.module('feedService', ['urlEncodingService', 'Feed', 'FeedItem', 'FeedProvider', 'Request', 'Node'])

    .factory('$feedService', ['$sessionService', '$urlEncode', 'Feed', 'FeedItem', 'FeedProvider', '$displayMessageService', 'Request', 'Node',
			function($sessionService, $urlEncode, Feed, FeedItem, FeedProvider, $displayMessageService, Request, Node){

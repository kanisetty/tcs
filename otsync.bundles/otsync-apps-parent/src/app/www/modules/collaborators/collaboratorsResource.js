angular.module('collaboratorsResource', ['collaboratorFactory', 'urlEncodingService', 'emailService', 'Request'])

    .factory('$collaboratorsResource', ['$q', '$sessionService', 'collaboratorFactory', '$urlEncode', '$displayMessageService', '$emailService', 'Request',

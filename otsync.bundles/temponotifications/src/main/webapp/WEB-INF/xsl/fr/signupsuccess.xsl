							...
							<div class="yui-g">
								<div class="formdlg">
									...
									<div class="formdlgmiddle">
										<div class="formdlgmessage">Merci! Votre compte est désormais configuré et prêt à l’emploi. Un courrier électronique, avec les informations relatives à votre compte et des liens utiles, a été envoyé à l’adresse</div>

							...
							<div class="yui-g">
								<div class="formdlg">
									...
									<div class="formdlgmiddle">
										<div class="formdlgmessage">Vielen Dank. Ihr Konto ist nun eingerichtet und zur Nutzung bereit. Eine E-Mail mit Ihren Kontoinformationen und hilfreichen Verknüpfungen wurde gesendet an</div>

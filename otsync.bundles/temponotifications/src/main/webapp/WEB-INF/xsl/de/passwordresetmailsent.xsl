...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:variable name="pagetitle" select="'Password zurücksetzen'"/>
	<xsl:template match="/">
		<html>
							...
							<div class="yui-g">
								<div class="formdlg">
									...
									<div class="formdlgmiddle">
										<div class="formdlgmessage">Vielen Dank. Ihre E-Mail wurde gesendet an</div>
										...
										<div class="formdlgmessage">Klicken Sie auf die Verknüpfung in der E-Mail, um Ihr Kennwort zurückzusetzen.</div>
									</div>
									<xsl:call-template name="form-line-spacer"></xsl:call-template>

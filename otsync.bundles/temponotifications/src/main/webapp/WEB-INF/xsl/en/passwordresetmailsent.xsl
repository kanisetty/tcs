							...
							<div class="yui-g">
								<div class="formdlg">
									...
									<div class="formdlgmiddle">
										<div class="formdlgmessage">Thank you. An e-mail has been sent to</div>
										...
										<div class="formdlgmessage">Please click on the link provided in the e-mail to reset your password.</div>
									</div>
									<xsl:call-template name="form-line-spacer"></xsl:call-template>

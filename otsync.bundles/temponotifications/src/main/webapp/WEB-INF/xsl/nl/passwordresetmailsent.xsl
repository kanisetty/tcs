							...
							<div class="yui-g">
								<div class="formdlg">
									...
									<div class="formdlgmiddle">
										<div class="formdlgmessage">Dank u. Er is een e-mail verzonden naar</div>
										...
										<div class="formdlgmessage">Klik op de koppeling in de e-mail om uw wachtwoord opnieuw in te stellen.</div>
									</div>
									<xsl:call-template name="form-line-spacer"></xsl:call-template>

							...
							<div class="yui-g">
								<div class="formdlg">
									...
									<div class="formdlgmiddle">
										<div class="formdlgmessage">Gracias. Se ha enviado un correo electrónico a</div>
										...
										<div class="formdlgmessage">Haga clic en el enlace que se indica en el correo electrónico para restablecer su contraseña.</div>
									</div>
									<xsl:call-template name="form-line-spacer"></xsl:call-template>

							...
							<div class="yui-g">
								<div class="formdlg">
									...
									<div class="formdlgmiddle">
										<div class="formdlgmessage">Спасибо. Сообщение электронной почты отправлено на адрес</div>
										...
										<div class="formdlgmessage">Чтобы сбросить пароль, щелкните ссылку в сообщении электронной почты.</div>
									</div>
									<xsl:call-template name="form-line-spacer"></xsl:call-template>

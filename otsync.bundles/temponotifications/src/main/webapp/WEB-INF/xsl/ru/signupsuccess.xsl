							...
							<div class="yui-g">
								<div class="formdlg">
									...
									<div class="formdlgmiddle">
										<div class="formdlgmessage">Спасибо! Ваша учетная запись настроена и готова к использованию. Сообщение электронной почты с данными вашей учетной записи и полезными ссылками отправлено на адрес</div>

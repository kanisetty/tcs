							...
							<div class="yui-g">
								<div class="formdlg">
									...
									<div class="formdlgmiddle">
										<div class="formdlgmessage">Merci. Un courrier électronique a été envoyé à l’adresse</div>
										...
										<div class="formdlgmessage">Veuillez cliquer sur le lien fourni dans le courrier électronique pour réinitialiser votre mot de passe.</div>
									</div>
									<xsl:call-template name="form-line-spacer"></xsl:call-template>

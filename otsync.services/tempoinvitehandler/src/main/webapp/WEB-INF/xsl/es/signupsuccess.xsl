							...
							<div class="yui-g">
								<div class="formdlg">
									...
									<div class="formdlgmiddle">
										<div class="formdlgmessage">¡Gracias! Se ha configurado su cuenta y ya puede utilizarla. Se ha enviado un correo electrónico con la información de su cuenta y enlaces útiles a</div>

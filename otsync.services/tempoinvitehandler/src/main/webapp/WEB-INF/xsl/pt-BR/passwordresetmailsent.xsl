							...
							<div class="yui-g">
								<div class="formdlg">
									...
									<div class="formdlgmiddle">
										<div class="formdlgmessage">Obrigado. Um e-mail foi enviado para</div>
										...
										<div class="formdlgmessage">Clique no link fornecido no e-mail para redefinir sua senha.</div>
									</div>
									<xsl:call-template name="form-line-spacer"></xsl:call-template>

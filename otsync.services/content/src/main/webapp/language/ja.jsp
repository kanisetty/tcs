...
<%
	 platform_not_supported = "ご使用のプラットフォームはサポートされていません。";
	...
	//iOS
	 ...
	 ios_install_build = "最新ビルドのインストール";
	 ios_os_detected_pre = "iOS ";
	 ios_os_detected_post =  "削除されました";
	...
	//Download Text
	 ...
	 win_download_text_32_bit = "32 ビットのダウンロード";
	 win_download_text_64_bit = "64 ビットのダウンロード";
	 win_alttext_32_bit = "32 ビット クライアント";
	 win_alttext_64_bit = "64 ビット クライアント";
		
	//WINDOWS
	 win_version = "バージョン";
	 win_reliable_etc = "実績を備えた信頼できる {0} 環境向けの信用性の高いファイル共有および同期機能。";
	 win_or_download = "または、次のものをダウンロードしてください。 ";

...
<%
	 platform_not_supported = "Sua plataforma não é compatível.";
	...
	//iOS
	 ...
	 ios_install_build = "Instalar última compilação";
	 ios_os_detected_pre = "iOS ";
	 ios_os_detected_post =  "detectado";
	...
	//Download Text
	 ...
	 win_download_text_32_bit = "DOWNLOAD PARA 32 BITS";
	 win_download_text_64_bit = "DOWNLOAD PARA 64 BITS";
	 win_alttext_32_bit = "Cliente de 32 bits";
	 win_alttext_64_bit = "Cliente de 64 bits";
		
	//WINDOWS
	 win_version = "VERSÃO";
	 win_reliable_etc = "Compartilhamento e sincronização confiável de arquivos para ambientes {0} comprovados e confiáveis.";
	 win_or_download = "Ou, baixe o ";

...
<%
	 platform_not_supported = "您的平台不受支持。";
	...
	// Android
	 ...
	 and_install_build = "安装";
	 android_os_detected_pre = "检测到 Android OS";
	...
	//iOS
	 ...
	 ios_install_build = "安装最新内部版本";
	 ios_os_detected_pre = "iOS ";
	 ios_os_detected_post =  "已检测";
	...
	//Download Text
	 ...
	 win_download_text_32_bit = "下载 32 位";
	 win_download_text_64_bit = "下载 64 位";
	 win_alttext_32_bit = "32 位客户端";
	 win_alttext_64_bit = "64 位客户端";
		
	//WINDOWS
	 win_version = "版本";
	 win_reliable_etc = "针对成熟且可靠的 {0} 环境的可靠文件共享和同步。";
	 win_or_download = "或者，下载 ";

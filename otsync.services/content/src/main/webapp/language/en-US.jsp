...
<%
	String platform_not_supported = "Your platform is not supported.";
	...
	String and_install_build = "Install";
	String android_os_detected_pre = "Android OS";
	...
	String ios_install_build = "Install Latest Build";
	String ios_os_detected_pre = "iOS ";
	String ios_os_detected_post =  "detected";
	...
	String win_download_text_32_bit = "DOWNLOAD 32 BIT";
	String win_download_text_64_bit = "DOWNLOAD 64 BIT";
	String win_alttext_32_bit = "32-bit client";
	String win_alttext_64_bit = "64-bit client";
		
	//WINDOWS
	String win_version = "VERSION";
	String win_reliable_etc = "Reliable file sharing and synchronization for the proven and trusted {0} environment.";
	String win_or_download = "Or, download the ";

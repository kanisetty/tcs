...
<%
	...
	//iOS
	 ...
	 ios_install_build = "Installa build più recente";
	 ios_os_detected_pre = "iOS ";
	 ios_os_detected_post =  "rilevato";
	...
	//Download Text
	 ...
	 win_download_text_32_bit = "SCARICA VER. A 32 BIT";
	 win_download_text_64_bit = "SCARICA VER. A 64 BIT";
	 win_alttext_32_bit = "Client a 32 bit";
	 win_alttext_64_bit = "Client a 64 bit";
		
	//WINDOWS
	 win_version = "VERSIONE";
	 win_reliable_etc = "Sincronizzazione e condivisione file affidabili per ambiente OpenText testato e attendibile.";
	 win_or_download = "In alternativa, scaricare ";

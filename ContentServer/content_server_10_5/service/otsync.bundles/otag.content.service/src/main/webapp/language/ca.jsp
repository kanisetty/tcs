...
<%
	...
	//iOS
	 ...
	 ios_install_build = "Instal·leu el darrer muntatge";
	 ios_os_detected_pre = "iOS ";
	 ios_os_detected_post =  "detectat";
	...
	//Download Text
	 ...
	 win_download_text_32_bit = "BAIXA 32 BITS";
	 win_download_text_64_bit = "BAIXA 64 BITS";
	 win_alttext_32_bit = "Client de 32 bits";
	 win_alttext_64_bit = "Client de 64 bits";
		
	//WINDOWS
	 win_version = "VERSIÓ";
	 win_reliable_etc = "Ús compartit de fitxers i sincronització fiable per a l'entorn {0} provat i de confiança.";
	 win_or_download = "o bé, baixa la ";

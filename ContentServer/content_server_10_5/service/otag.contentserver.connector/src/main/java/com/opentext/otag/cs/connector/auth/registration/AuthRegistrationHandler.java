...
/**
 * Appworks component that registers the {@code ContentServerAuthHandler} with the
...
public class AuthRegistrationHandler extends AbstractMultiChangeSettingHandler implements AppworksServiceContextHandler {
    ...
    public void onStart(String appName) {
        ...
        addHandler(CsConnectorConstants.CS_AUTH_ONLY, (s) -> {
    ...
    public Set<String> getSettingKeys() {
        return Sets.newHashSet(Arrays.asList(
                CsConnectorConstants.CS_URL, CsConnectorConstants.CS_AUTH_ONLY));
    }

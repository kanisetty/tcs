...
public class IncomingShareID extends ResourcePath {
    ...
    protected void doPut(HttpServletRequest req, HttpServletResponse resp,
        ...
        boolean accepted = ContentServiceConstants.TRUE_STRING.equalsIgnoreCase(req.getParameter(Message.ACCEPTED_KEY_NAME));
        boolean rejected = ContentServiceConstants.TRUE_STRING.equalsIgnoreCase(req.getParameter(Message.REJECTED_KEY_NAME));

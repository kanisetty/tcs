...
<body>
			...
			<div id="login-wrapper">
				<div id="login-pane" class="content-pane">
					...
					<div class="login-bottom">
						<div class="login-right"><button id="loginButton" class="ui-button-primary">Login</button></div>
					</div>
				</div>
			</div>
	...
	<div id="setup" class="ui-widget">
		<div class="tracker-header">
			...
			<div class="user-actions"><button id="logoutButton" class="ui-button-primary ui-button-small">Logout</button></div>
		</div>

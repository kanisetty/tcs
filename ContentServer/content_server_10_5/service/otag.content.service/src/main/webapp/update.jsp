...
<% if("BB".equalsIgnoreCase(os)) { %>
	<div  data-role="page" data-theme="b">
		<div  data-role="header" ><h1><%=MessageFormat.format(ot_tempo_installer, ServletConfig.getProductName())%></h1></div>
		<div  data-role="content">
			<p><%=MessageFormat.format(bb_install_instruction, ServletConfig.getProductName()) %></p>
			<p><%=bb_install_instruction_2 %></p>
			<p><%=bb_install_instruction_3 %></p>
			<p class="version-info" id="device"></p>

			<div data-role="controlgroup">
				<a id="bbdownloadlink" href="<% out.print(location); %>" data-role="button" rel="external"><%=bb_install_build %></a>
			</div>
...
<% } else if("android".equalsIgnoreCase(os) && !osNotSupported ) { %>
	<div  data-role="page" data-theme="b"> 
		<div  data-role="header" ><h1><%=MessageFormat.format(ot_tempo_installer, ServletConfig.getProductName())%></h1></div>
		<div  data-role="content">
			<p><%=MessageFormat.format(and_install_instruction, ServletConfig.getProductName())%></p>
			<p><%=and_install_instruction_2%></p>
			<p><%=and_install_instruction_3%></p>
			<p class="version-info">
				<%=android_os_detected_pre%> <% out.print(androidVersion); %> <%=and_os_detected_post%><% if(osVersionNotSupported) {%><%=and_version_not_supported %></p><% }else{ %></p>
			<div data-role="controlgroup">
				<a id="bbdownloadlink" href="<% out.print(location); %>" data-role="button" rel="external"><%=and_install_build %></a>
			</div>
			<% } %>
...
<% } else if("ios".equalsIgnoreCase(os) && !osNotSupported) { %>
	<div  data-role="page" data-theme="b"> 
		<div  data-role="header" ><h1><%=MessageFormat.format(ot_tempo_installer, ServletConfig.getProductName())%></h1></div>
		<div  data-role="content">
			<p><%=MessageFormat.format(ios_install_instruction, ServletConfig.getProductName())%></p>
			<p><%=ios_install_instruction_2%></p>
			<p><%=ios_install_instruction_3%></p>
			<p class="version-info">
				<%=ios_os_detected_pre%><% out.print(iOSVersion); %> <%=ios_os_detected_post%><% if(osVersionNotSupported) {%><%=ios_version_not_supported %></p><% }else{ %></p>
			<div data-role="controlgroup">
				<a id="bbdownloadlink" href="<% out.print(location); %>" data-role="button" rel="external"><%=ios_install_build%></a>
			</div>
			<% } %>
...
<% } else if("win".equalsIgnoreCase(os) && !osNotSupported) { %>
	<div id="info">
		...
		<div>
			...
			<p><%=MessageFormat.format(win_reliable_etc, ServletConfig.getCompanyName())%></p>
		</div>
		<% if (showBoth) { %>

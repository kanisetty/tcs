...
public class CSForwardHeaders extends ForwardHeaders {
    ...
    @JsonCreator
    public CSForwardHeaders(@JsonProperty("remoteAddr") String remoteAddr, @JsonProperty("forwardHeader") String forwardHeader, @JsonProperty("userAgent") String userAgent, @JsonProperty("lang") String lang, @JsonProperty("ifModifiedSince") String ifModifiedSince, @JsonProperty("uri") String uri, @JsonProperty("otherHeaders") Map<String, String> otherHeaders) {

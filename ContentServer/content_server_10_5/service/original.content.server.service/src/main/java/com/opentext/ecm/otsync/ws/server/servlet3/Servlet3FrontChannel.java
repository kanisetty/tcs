...
public class Servlet3FrontChannel {
	...
	public Servlet3FrontChannel(
			final SuspendedActionQueue sharedThreadPool,
			final MessageConverter messageConverter,
			final SynchronousMessageSwitch messageHandler) {
	...
	public MessageConverter getMessageConverter(){ return _messageConverter; }
	...
	private void sendFrontChannelPayload(HttpServletRequest request, AsyncContext asyncRequest, Map<String, Object> payload,
		...
		RequestHeader headers = new RequestHeader(request);

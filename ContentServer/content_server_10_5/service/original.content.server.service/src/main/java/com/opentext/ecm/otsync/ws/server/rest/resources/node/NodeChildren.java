...
public class NodeChildren extends ResourcePath {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp,
		...
		else if(ServerConstants.TRUE_STRING.equalsIgnoreCase(req.getParameter(Message.RECURSIVE_KEY_NAME))) {
	...
	private void search(HttpServletRequest req, String node, String filter) {
		...
		boolean descending = ServerConstants.TRUE_STRING.equalsIgnoreCase(req.getParameter(Message.DESCENDING_KEY_NAME));

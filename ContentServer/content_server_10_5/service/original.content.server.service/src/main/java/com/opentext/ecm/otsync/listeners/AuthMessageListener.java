...
public class AuthMessageListener implements SynchronousMessageListener {
	...
	// TODO FIXME ???? THis is attempting to perform client wipe duties!!!! WE need to look carefully at this one
...
//		}
        ...
        return null; // TODO FIXME this method should not exist
	}
...
//	}
	...
	public int getMaxStoredResponses(Map<String, Object> message) {
		...
		int maxStoredResponses = ServletConfig.DEFAULT_STORED_RESPONSES;
		...
		if(message.containsKey(Message.MAX_STORED_RESPONSES_KEY_NAME)){
			try{
				...
				AbstractOTSyncServlet.log.warn("Client sent non-integer for max stored responses", e);

...
public class PulseMessageListener implements MessageForwarder {
	...
	public Payload forwardRequest(Payload payload) throws JsonProcessingException, IOException {
        AbstractOTSyncServlet.log.info("PuleMessageListener#forwardRequest()");
	...
	private Payload getComments(Payload payload) throws JsonProcessingException, IOException {
		Payload info = payload.getInfo();
		Map<String, String> params = new HashMap<String, String>();;
		String url = ServletConfig.getContentServerUrl() + PULSE_COMMENTS_PATH;
		...
		Payload responsePayload = preparePulseResponse(in);

		return responsePayload;
	}

	private Payload preparePulseResponse(String in)
	...
	private Payload addComment(Payload payload) throws JsonProcessingException, IOException {
		Payload info = payload.getInfo();		
		Map<String, String> params = new HashMap<String, String>();
		...
		String url = ServletConfig.getContentServerUrl() + PULSE_UPDATE_PATH;
